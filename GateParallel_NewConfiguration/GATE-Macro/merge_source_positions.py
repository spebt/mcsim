...
source_positions_pattern = "/vscratch/grp-rutaoyao/Tridev/source_positions_*.parquet"

# Merge files and store unique values
source_positions_combined = merge_parquet_files(source_positions_pattern)

# Save to a new Parquet file
source_positions_combined.to_parquet("/vscratch/grp-rutaoyao/Tridev/"+"merged_source_positions.parquet", index=False)
